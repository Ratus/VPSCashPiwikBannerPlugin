...
namespace Piwik\Plugins\VpsCashPromo\Reports;
 ...
 */
class GetBannerstatistics extends Base
{
    protected function init()
    {
        parent::init();

        $this->menuTitle = 'Banner statistics';
        $this->widgetTitle  = 'Banner statistics';

        $this->name          = Piwik::translate('VpsCashPromo_Bannerstatistics');
        $this->dimension     = null;
        ...
        // By default standard metrics are defined but you can customize them by defining an array of metric names
         //$this->metrics       = array('Content name');
        //$this->metrics = array('Total visits', 'Total impressions', 'Total interactions', 'Interaction rate');
        ...
        // $this->menuTitle    = 'VpsCashPromo_Bannerstatistics';
        ...
        // $this->widgetTitle  = 'VpsCashPromo_Bannerstatistics';
    }
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        //$view->config->columns_to_display = array_merge(array('Content name'), $this->metrics);
    }
    ...
    {
        $view = new View('@VpsCashPromo/getBannerstatistics');
        $view->myData = array();
